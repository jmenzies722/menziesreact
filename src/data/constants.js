...
export const experiences = [
  {
    ...
    desc: "Developed a cutting-edge Full Stack Application using the latest technologies to create a seamless integration of frontend and backend environments.",
    skills: [
      "Docker",
      "Mongo DB",
      "AWS",
  ...
  },
  {
    ...
    role: "Lead Project Design Senior Capstone at University of Hartford",
    company: "University of Hartford",
    date: "September 2022 - May 2023",
    desc: "Designed a medical app featuring IoT integration with an ESP32 WiFi module, enabling user interaction with a hardware medical dispenser through a user-friendly interface.",
    skills: [
      "ReactJS",
      "Redux",
      "Node.js",
...
export const education = [
  {
    ...
    grade: "Certification of Completion",
    date: "June 2023 - January 2024",
    desc: "Successfully completed a rigorous Full Stack Software Engineering Bootcamp, honing practical software development skills with a focus on the latest technologies and fostering collaborative teamwork.",
  ...
  },
  {
    ...
    school: "North Babylon High School",
    grade: "High School Diploma",
    date: "September 2015 - May 2019",
    desc: "Completed an Advanced Placement (AP) computer science course, contributing to a solid educational background that prepared the foundation for further studies and career development in the field of technology.",
